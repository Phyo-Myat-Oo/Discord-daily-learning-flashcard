...
- Neuroscience concept cards require exactly three recall checks—core, mechanism, and application—and one concrete `active_exercise` with a named output. Practical days require one prediction/check. Generic filler such as “write three sentences” is invalid.
